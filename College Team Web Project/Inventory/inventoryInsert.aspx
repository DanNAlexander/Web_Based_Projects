<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inventoryInsert.aspx.cs" Inherits="appSales.inventoryInsert" %>
...
<body>
    ...
    <div>
        ...
        <h1 class="container"><strong>Inventory Insert</strong></h1>
        <br />
    </div>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <div class="xtracolour">
                <table class="container" style="width: 42%;">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:DropDownList CssClass="dropdownsize" ID="ddlProductID" runat="server" DataSourceID="obsProduct" DataTextField="prodName" DataValueField="id" AppendDataBoundItems="True">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:Label ID="lblInfo" runat="server" Text="* Product could only be saved once." Font-Bold="True" ForeColor="Red"></asp:Label>
                            <br />
                            </td>
                    </tr>
                    <tr>
            ...
            <asp:ObjectDataSource ID="obsProduct" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="librarySales.SalesDataSetTableAdapters.productInventoryTableAdapter"></asp:ObjectDataSource>
        </div>
    </form>
